...
if ! assert_in_file $log_file "G729/8000"; then
  exit 1
fi

if ! assert_in_file $log_file "G722/8000"; then
  exit 1
fi

if ! assert_in_file $log_file "PCMU/8000"; then
  exit 1
fi

if ! assert_in_file $log_file "PCMA/8000"; then
  exit 1
fi

if ! assert_in_file $log_file "GSM/8000"; then
  exit 1
fi
