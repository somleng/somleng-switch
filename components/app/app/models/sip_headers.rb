SIPHeaders = Data.define(:call_sid, :account_sid, :carrier_sid, :call_direction, :billing_enabled, :billing_mode, :billing_category, :proxy_address, :external_profile, :destination) do
  def billing_enabled?
  ...
  def to_h
    {
      ...
      "X-Somleng-Destination" => destination
