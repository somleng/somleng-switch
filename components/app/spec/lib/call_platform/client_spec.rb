  ...
  RSpec.describe Client do
    describe "#create_media_stream" do
      it "creates a media stream" do
        stub_request(
          :post,
          "https://services.somleng.org/media_streams"
        ).to_return(body: { "sid" => "393a227f-0602-4024-b38a-dcbbeed4d5a0" }.to_json)
        client = Client.new(http_client_options: { url: "https://services.somleng.org" })
        ...
        expect(WebMock).to(have_requested(:post, "https://services.somleng.org/media_streams").with { |request|
