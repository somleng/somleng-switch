...
namespace
{
  static const char *basicAuthUser = std::getenv("MOD_TWILIO_STREAM_HTTP_AUTH_USER");
  static const char *basicAuthPassword = std::getenv("MOD_TWILIO_STREAM_HTTP_AUTH_PASSWORD");

  static const char *requestedTcpKeepaliveSecs = std::getenv("MOD_TWILIO_STREAM_TCP_KEEPALIVE_SECS");
